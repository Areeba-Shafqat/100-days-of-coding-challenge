...
console.log("Unfortunately! I Have Space For Only Two Guests.So, I Can Only Invite Two Guests.");
while (guestLists.length > 2) {
    var deleteGuests = guestLists.pop();
    console.log("Sorry!\n".concat(deleteGuests, ", I Can't Invite You To Dinner."));
}
guestLists.forEach(function (guests) {
    console.log("Hello! Dear ".concat(guests, ", You Are Still Invited Today For Dinner."));
});
